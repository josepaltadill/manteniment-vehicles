insert into validation.concurrency_barrier (session_id) values ('a');
do $$
...
begin
  begin
    ...
    raise notice 'CASE|concurrency.session-a|delete-or-23514|delete|PASS';
  exception when check_violation then
    raise notice 'CASE|concurrency.session-a|delete-or-23514|23514|PASS';
  end;
end;
$$;
commit;
